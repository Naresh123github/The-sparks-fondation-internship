...
<head>
    ...
    <title>Contact us - apna Bank</title>
</head>

<body style="width:80%; background-color:gray; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:cadetblue; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
